...
+ [Alignment](#section2)
	...
	+ Format alignment
		+ *fine-tuning and in-context alignment*
	+ Prompt engineering
...
10. **Reasoning with Language Model Prompting: A Survey** arXiv(2022.12)
...
11. **A Survey of Reasoning with Foundation Models** arXiv(2023.12)
...
8. **Is Prompt All You Need? No. A Comprehensive and Broader View of Instruction Learning** arXiv(2023.03)
...
9. **A Practical Survey on Zero-shot Prompt Design for In-context Learning** ranlp(2023.09)

	*Yinheng Li* [[Paper](https://aclanthology.org/2023.ranlp-1.69/)]

10. **Prompting Frameworks for Large Language Models: A Survey** arXiv(2023.11)
...
11. **Unleashing the potential of prompt engineering in Large Language Models: a comprehensive review** arXiv(2023.10)

	*Banghao Chen, Zhaofeng Zhang, Nicolas Langrené, Shengxin Zhu* [[Paper](https://arxiv.org/abs/2310.14735)]

12. **A Survey of Chain of Thought Reasoning: Advances, Frontiers and Future** arXiv(2023.10)
...
13. **Towards Better Chain-of-Thought Prompting Strategies: A Survey** arXiv(2023.10)

	*Zihan Yu, Liang He, Zhen Wu, Xinyu Dai, Jiajun Chen* [[Paper](https://doi.org/10.48550/arXiv.2310.04959)]

14. **A Survey of Chain of Thought Reasoning: Advances, Frontiers and Future** arXiv(2023.09)

	*Zheng Chu, Jingchang Chen, Qianglong Chen, Weijiang Yu, Tao He, Haotian Wang, Weihua Peng, Ming Liu, Bing Qin, Ting Liu* [[Paper](https://arxiv.org/abs/2309.15402)] [[GitHub](https://github.com/zchuz/CoT-Reasoning-Survey)]

15. **Igniting Language Intelligence: The Hitchhiker's Guide From Chain-of-Thought Reasoning to Language Agents** arXiv(2023.11)
...
#### Societal Issues<a id="section5"></a>
...
6. **Survey of Vulnerabilities in Large Language Models Revealed by Adversarial Attacks** arXiv(2023.1)
...
7. **A Survey on Large Language Model (LLM) Security and Privacy: The Good, the Bad, and the Ugly** arXiv(2023.12)

	*Yifan Yao, Jinhao Duan, Kaidi Xu, Yuanfang Cai, Zhibo Sun, Yue Zhang* [[Paper](https://arxiv.org/pdf/2312.02003)]

8. **Tricking LLMs into Disobedience: Formalizing, Analyzing, and Detecting Jailbreaks** arXiv(2023.05)

	*Abhinav Rao, Sachin Vashistha, Atharva Naik, Somak Aditya, Monojit Choudhury* [[Paper](https://arxiv.org/abs/2305.14965)]

#### Misinformation<a id="section7"></a>
...
10. **A Survey on Hardware Accelerators for Large Language Models** arXiv(2024.01)
...
4. **The Contribution of Knowledge in Visiolinguistic Learning: A Survey on Tasks and Challenges** arXiv(2023.03)

	*Maria Lymperaiou, Giorgos Stamou* [[Paper](https://arxiv.org/abs/2303.02411)]

5. **Towards Reasoning in Large Language Models: A Survey** arXiv(2022.12)

	*Jie Huang, Kevin Chen-Chuan Chang* [[Paper](https://arxiv.org/abs/2212.10403)] [[GitHub](https://github.com/jeffhj/LM-reasoning)]

6. **Trends in Integration of Knowledge and Large Language Models: A Survey and Taxonomy of Methods, Benchmarks, and Applications** arXiv(2023.11)
...
7. **Knowledge Editing for Large Language Models: A Survey** arXiv(2023.1)

	*Song Wang, Yaochen Zhu, Haochen Liu, Zaiyi Zheng, Chen Chen, Jundong Li* [[Paper](https://arxiv.org/pdf/2310.16218.pdf)]

8. **Editing Large Language Models: Problems, Methods, and Opportunities** arXiv(2023.05)
...
8. **Large Language Models for Robotics: A Survey** arXiv(2023.11)

	*Fanlong Zeng, Wensheng Gan, Yongheng Wang, Ning Liu, Philip S. Yu* [[Paper](https://arxiv.org/abs/2311.07226)]

9. **A Survey on Multimodal Large Language Models for Autonomous Driving** WACV workshop(2023.11)
...
10. **LLM4Drive: A Survey of Large Language Models for Autonomous Driving** arXiv(2023.11)
...
11. **Automatically Correcting Large Language Models: Surveying the landscape of diverse self-correction strategies** arXiv(2023.08)
...
12. **A Survey on Large Language Model based Autonomous Agents** arXiv( 2023.08)
...
13. **The Rise and Potential of Large Language Model Based Agents: A Survey** arXiv(2023.09)
...
14. **Large Language Models Empowered Agent-based Modeling and Simulation: A Survey and Perspectives** arXiv(2023.12 )
...
15. **Large Multimodal Agents: A Survey** arXiv(2024.02)
...
18. **When Large Language Models Meet Citation: A Survey** arXiv(2023.09)
...
24. **Large Language Models for Information Retrieval: A Survey** arXiv(2023.08)
...
25. **Large Language Models for Software Engineering: Survey and Open Problems** arXiv(2023.10)
...
26. **Large Language Models for Software Engineering: A Systematic Literature Review** arXiv(2023.08)
...
27. **Large Language Models for Generative Information Extraction: A Survey** arXiv(2023.12)
...
28. **Summary of ChatGPT-Related Research and Perspective Towards the Future of Large Language Models** Meta-Radiology(2023.08)
...
29. **A Survey of Graph Meets Large Language Model: Progress and Future Directions** arXiv(2023.11)

	*Yuhan Li, Zhixun Li, Peisong Wang, Jia Li, Xiangguo Sun, Hong Cheng, Jeffrey Xu Yu* [[Paper](https://arxiv.org/pdf/2311.12399)]

30. **Large Language Models on Graphs: A Comprehensive Survey** arXiv(2023.12)
...
31. **A Comprehensive Survey on Pretrained Foundation Models: A History from BERT to ChatGPT** arXiv(2023.05)
...
32. **AI-Augmented Surveys: Leveraging Large Language Models and Surveys for Opinion Prediction** arXiv(2023.09)
